   ...
   static {
    ...
    public void run(){
        try {
            ...
            System.err.println("Please ensure the required CSV files are present: " + e.getMessage());
            System.exit(1);        }
        catch (WarehouseException e) {
            System.err.println("Failed to initialize the warehouse: " + e.getMessage());
            System.exit(2);        }
    ...
    private void doMenuAction(int mainMenuChoice, int subMenuChoice){
        if(mainMenuChoice ==  1){
            ...
            throw new IllegalStateException("There are only 4 Main menu options, this cannot happen.");
        }
    }
